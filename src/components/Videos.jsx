...
const Videos = () => {
  ...
  return (
    ...
    //    controlsList='nodownload'
       ...
       <VStack alignContent={'flex-start'} p={'8'} w={'full'} overflowY={'auto'}>
        <Heading>Sample Video</Heading>
        <Text>
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officiis tenetur consequatur exercitationem dolores sapiente blanditiis deleniti, magnam sed iure ex distinctio neque? Necessitatibus harum architecto rerum beatae eaque accusantium non voluptatibus ad quo voluptates? Soluta id sed sint voluptatum fugit officiis suscipit quae rem accusantium, commodi velit fuga pariatur nihil minus dolor. Maxime quas earum laborum incidunt corporis. Quis eligendi harum non cumque id officia nulla ad odit sed aliquid? Voluptates quasi facilis quis laboriosam veritatis delectus molestias dolor iure vero sunt? Unde, quod, nisi doloribus odit impedit quaerat, molestias deserunt exercitationem commodi dolorem nihil asperiores! Quisquam maxime omnis vitae!
        </Text>
       </VStack>
 ...
 {/* first element related to phone other related to big screen */}
    {
